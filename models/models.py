...
class AreaCotacao(db.Model):
    ...
    extracao = db.Column(db.String(15), nullable=False)
    modalidade = db.Column(db.String(15), nullable=False)
    cotacao = db.Column(db.Integer, nullable=False)
    ativar_area_cotacao = db.Column(db.Integer, nullable=False)
...
class Operador(db.Model):
    ...
    regiao = db.Column(db.Text, nullable=False)
    ativo = db.Column(db.Text, nullable=False)
    area = db.Column(db.String(15), nullable=False)
    login = db.Column(db.String(15), nullable=False)
    senha = db.Column(db.String(15), nullable=False)
    comissao = db.Column(db.Integer, nullable=False)
    cancelar_poule = db.Column('CancelarPoule', db.Text, nullable=False)
    exibe_comissao = db.Column('ExibeComissao', db.Text, nullable=False)
    limite_venda = db.Column('LimiteVenda', db.Integer, nullable=False)
    premiacao = db.Column(db.Text, nullable=False)
    tipo_limite = db.Column('TipoLimite', db.Text, nullable=False)
    grade = db.Column(db.String(15), nullable=False)
    teste = db.Column(db.Text, nullable=False)
    comissao_retida = db.Column('ComissaoRetida', db.String(10), nullable=False)
    serial_maquina = db.Column('SerialMaquina', db.String(25), nullable=False)
